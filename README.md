...
- Export processed transactions to CSV or Excel
...
Transactions are classified using non-LLM techniques. The classification layer supports:
...
The assessment specifically requires transaction classification without relying on LLMs. This implementation therefore uses traditional approaches:
...
The project includes a synthetic bank statement generator: `dummy_statement_generator.py`
